...
def data_table_hplc(amt):
  ...
  #  Chl_c1c2 = amt['hplc_Chl_c1c2'].to_pandas() - not present in AMT23
  ...
  #  mg_DVP = amt['hplc_Mg_DVP'].to_pandas()
    ...
    #phide_a = amt['hplc_Phide_a'].to_pandas() - not present in AMT23
   # phytin_a = amt['hplc_Phytin_a'].to_pandas() -not present in AMT23
...
if __name__ == '__main__':
        ...
        # nc file #
        finalnc = '/users/rsg/tjor/scratch_network/AMT_underway/AMT23/Processed/underway/Step3/amt23_final_with_debiased_chl.nc' # hardcoded
        ...
        # document files
        fn_docs_acs = 'checklist_acs_particulate_inline_AMT23.rtf,checklist_acs_ag_cg_AMT23.rtf,AMT23_ACS_inline_ProcessingReport.docx' # hardcoded
        ...
        fn_docs_hplc = 'checklist_hplc_PML_AMT23.rtf,AMT23_Pigments_methods.docx,AMT23_Pigments_metadata.xlsx,AMT_23_Pigments.xlsx' #hardcoded
